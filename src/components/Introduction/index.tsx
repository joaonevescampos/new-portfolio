...
export function Introduction() {
    return (
        <div id="home"  className="flex flex-col items-center justify-center md:flex-row-reverse md:justify-between md:items-start  mt-24 mb-8 md:px-8 max-w-[872px] w-full">
            <div>
                    <Image
                        src={photoProfile}
            ...
            <div>
                <div className="flex justify-center items-center md:items-start md:justify-start flex-col gap-8 my-4 px-8 md:px-0">
                    <div className="">
                    ...
                    <p className="scroll-m-20 text-base tracking-tight md:w-[410px]">
                    ...
                    <Button className="w-[100%]" variant="default">
                        <a href="#projects">Projetos</a>
                    </Button>
                </div>
                <div className="flex flex-col text-sm w-52 gap-4 pl-4 mt-8 ml-8 md:ml-0 border-l-4 border-purple-color01 dark:border-purple-700">
                    <div className="flex gap-2">
                        ...
                        className="font-bold text-purple-color01 dark:text-purple-color03" target="_blank">
                            Whats App
                        </a>
                    </div>
                    <div className="flex gap-2">
                        <FaGithub className="text-2xl text-purple-color01 dark:text-violet-400"  />
                        <a href="https://github.com/joaonevescampos" className="font-bold text-purple-color01 dark:text-purple-color03" target="_blank">Github</a>
                    </div>
                    <div className="flex gap-2">
                        <FaLinkedinIn className="text-2xl text-purple-color01 dark:text-violet-400" />
                        <a href="https://www.linkedin.com/in/joaonevescampos" className="font-bold text-purple-color01 dark:text-purple-color03" target="_blank">Linkedin</a>
                    </div>
                    <div className="flex gap-2">
